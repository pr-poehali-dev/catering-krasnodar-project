            ...
            <div className="bento-card overflow-hidden bg-[#e6e6e4]">
              <div className="grid lg:grid-cols-2">
                ...
                <div className="order-2 lg:order-1 p-4 sm:p-6 lg:p-8 xl:p-10 flex flex-col justify-center relative">
                  ...
                  <h1 className="font-sans text-[clamp(1.9rem,8vw,3.5rem)] sm:text-[clamp(1.6rem,6vw,3.5rem)] lg:text-[2.75rem] leading-[0.95] tracking-tightest font-medium text-balance text-graphite">
                    Гастробоксы,
                    <br />
                    в которые&nbsp;
                  ...
                  <p className="mt-2 sm:mt-4 text-[16px] sm:text-[19px] lg:text-[21px] text-graphite/75 leading-relaxed max-w-md font-serif italic">
