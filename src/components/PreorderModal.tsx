              ...
              <div className="grid sm:grid-cols-2 gap-3 mt-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full max-w-[180px] pl-11 pr-2 py-4 sm:py-3.5 rounded-2xl bg-snow border border-graphite/15 focus:border-graphite focus:ring-2 focus:ring-graphite/5 outline-none text-base sm:text-[14px] font-medium transition"
                  />
                </div>
                <div className="relative">
